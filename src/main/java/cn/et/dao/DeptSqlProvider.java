...
import cn.et.entity.DeptExample.Criteria;
import cn.et.entity.DeptExample.Criterion;
...
public class DeptSqlProvider {
     ...
     *
     * @mbg.generated Wed Dec 13 20:15:34 CST 2017
     */
    ...
    public String insertSelective(Dept record) {
        ...
        if (record.getDid() != null) {
            sql.VALUES("did", "#{did,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDid() != null) {
            sql.SET("did = #{record.did,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Dept record) {
        ...
        if (record.getDid() != null) {
            sql.SET("did = #{did,jdbcType=INTEGER}");
        }
